...
process coverage_stat {
 ...
 """
        ...
        echo " ... computing the uniformity of whole genome coverage stats for ${sample_id}"
...
sed -i '1iSample\tcov1x\tcov10x\tcov20x\tcov30x\tcov50x\tcov100x\tcov150x\tcov300x' ${sample_id}.base.coverage.perc_exß.txt
