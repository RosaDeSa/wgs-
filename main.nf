...
workflow {
 if (params.pcrfree) 
   pcr_free(input_ch,inputPairReads,fasta,genes_ch,index_ch,know_1000G,know_1000G_tbi,known_mills,known_mills_tbi,known_dbsnp,known_dbsnp_tbi,bed_ch,exons_ch)
 else
    pcr(input_ch,inputPairReads,fasta,genes_ch,index_ch,know_1000G,know_1000G_tbi,known_mills,known_mills_tbi,known_dbsnp,known_dbsnp_tbi,bed_ch,exons_ch)
}
